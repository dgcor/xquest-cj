...
extern int64_t StdJson2_ReadString(const uint8_t* str, int64_t left, int64_t right)
{
    int64_t i = left;
    while (i < right) {
...
extern int64_t StdJson2_FloatPrint(const double num, uint8_t* dest, const int64_t destSize)
{
